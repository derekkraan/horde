defmodule ClusterTest do
  ...
  describe ".join_hordes/2" do
    test "returns true when registries joined" do
      ...
      assert :ok = Horde.Cluster.join_hordes(:reg1, :reg2)
    end
